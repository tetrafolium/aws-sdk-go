...
var renamedPackages = map[string]*packageRenames{
	"github.com/tetrafolium/aws-sdk-go/service/autoscaling": &packageRenames{
	...
	"github.com/tetrafolium/aws-sdk-go/service/autoscaling/autoscalingiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/cloudformation": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"EventID":            "EventId",
	...
	"github.com/tetrafolium/aws-sdk-go/service/cloudformation/cloudformationiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/cloudfront": &packageRenames{
		operations: map[string]string{},
		shapes: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/cloudfront/cloudfrontiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/cloudhsm": &packageRenames{
		operations: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/cloudhsm/cloudhsmiface": &packageRenames{
		operations: map[string]string{
			"CreateHAPG":          "CreateHapg",
			"CreateHAPGPages":     "CreateHapgPages",
			"CreateHAPGRequest":   "CreateHapgRequest",
	...
	"github.com/tetrafolium/aws-sdk-go/service/cloudsearch": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"DomainID": "DomainId",
	...
	"github.com/tetrafolium/aws-sdk-go/service/cloudsearch/cloudsearchiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/cloudsearchdomain": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"ID":     "Id",
	...
	"github.com/tetrafolium/aws-sdk-go/service/cloudsearchdomain/cloudsearchdomainiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/cloudtrail": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/cloudtrail/cloudtrailiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/cloudwatch": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"AlarmARN": "AlarmArn",
	...
	"github.com/tetrafolium/aws-sdk-go/service/cloudwatch/cloudwatchiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/cloudwatchlogs": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"ARN":            "Arn",
	...
	"github.com/tetrafolium/aws-sdk-go/service/cloudwatchlogs/cloudwatchlogsiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/codecommit": &packageRenames{
		operations: map[string]string{},
		shapes: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/codecommit/codecommitiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/codedeploy": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/codedeploy/codedeployiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/codepipeline": &packageRenames{
		operations: map[string]string{},
		shapes: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/codepipeline/codepipelineiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/cognitoidentity": &packageRenames{
		operations: map[string]string{
			"GetID":                                     "GetId",
	...
	"github.com/tetrafolium/aws-sdk-go/service/cognitoidentity/cognitoidentityiface": &packageRenames{
		operations: map[string]string{
			"GetID":                                     "GetId",
			"GetIDPages":                                "GetIdPages",
			"GetIDRequest":                              "GetIdRequest",
	...
	"github.com/tetrafolium/aws-sdk-go/service/cognitosync": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/cognitosync/cognitosynciface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/configservice": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"ARN":                  "Arn",
	...
	"github.com/tetrafolium/aws-sdk-go/service/configservice/configserviceiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/datapipeline": &packageRenames{
		operations: map[string]string{},
		shapes: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/datapipeline/datapipelineiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/devicefarm": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"ARN":                 "Arn",
	...
	"github.com/tetrafolium/aws-sdk-go/service/devicefarm/devicefarmiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/directconnect": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"ASN":                "Asn",
	...
	"github.com/tetrafolium/aws-sdk-go/service/directconnect/directconnectiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/directoryservice": &packageRenames{
		operations: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/directoryservice/directoryserviceiface": &packageRenames{
		operations: map[string]string{
			"DisableSSO":        "DisableSso",
			"DisableSSOPages":   "DisableSsoPages",
			"DisableSSORequest": "DisableSsoRequest",
	...
	"github.com/tetrafolium/aws-sdk-go/service/dynamodb": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"IndexARN":        "IndexArn",
	...
	"github.com/tetrafolium/aws-sdk-go/service/dynamodb/dynamodbiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/dynamodbstreams": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"AWSRegion":               "AwsRegion",
	...
	"github.com/tetrafolium/aws-sdk-go/service/dynamodbstreams/dynamodbstreamsiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/ec2": &packageRenames{
		operations: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/ec2/ec2iface": &packageRenames{
		operations: map[string]string{
			"AcceptVPCPeeringConnection":           "AcceptVpcPeeringConnection",
			"AcceptVPCPeeringConnectionPages":      "AcceptVpcPeeringConnectionPages",
			"AcceptVPCPeeringConnectionRequest":    "AcceptVpcPeeringConnectionRequest",
	...
	"github.com/tetrafolium/aws-sdk-go/service/ecs": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"ARN":                   "Arn",
	...
	"github.com/tetrafolium/aws-sdk-go/service/ecs/ecsiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/efs": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/efs/efsiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/elasticache": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/elasticache/elasticacheiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/elasticbeanstalk": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/elasticbeanstalk/elasticbeanstalkiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/elastictranscoder": &packageRenames{
		operations: map[string]string{},
		shapes: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/elastictranscoder/elastictranscoderiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/elb": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"InstanceID":       "InstanceId",
	...
	"github.com/tetrafolium/aws-sdk-go/service/elb/elbiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/emr": &packageRenames{
		operations: map[string]string{},
		shapes: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/emr/emriface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/glacier": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"AccountID":         "AccountId",
	...
	"github.com/tetrafolium/aws-sdk-go/service/glacier/glacieriface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/iam": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"ARN":                      "Arn",
	...
	"github.com/tetrafolium/aws-sdk-go/service/iam/iamiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/kinesis": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/kinesis/kinesisiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/kms": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"ARN":              "Arn",
	...
	"github.com/tetrafolium/aws-sdk-go/service/kms/kmsiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/lambda": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/lambda/lambdaiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/machinelearning": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/machinelearning/machinelearningiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/mobileanalytics": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"ID": "Id",
	...
	"github.com/tetrafolium/aws-sdk-go/service/mobileanalytics/mobileanalyticsiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/opsworks": &packageRenames{
		operations: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/opsworks/opsworksiface": &packageRenames{
		operations: map[string]string{
			"AssociateElasticIP":             "AssociateElasticIp",
			"AssociateElasticIPPages":        "AssociateElasticIpPages",
			"AssociateElasticIPRequest":      "AssociateElasticIpRequest",
	...
	"github.com/tetrafolium/aws-sdk-go/service/rds": &packageRenames{
		operations: map[string]string{},
		shapes: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/rds/rdsiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/redshift": &packageRenames{
		operations: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/redshift/redshiftiface": &packageRenames{
		operations: map[string]string{
			"CreateHSMClientCertificate":           "CreateHsmClientCertificate",
			"CreateHSMClientCertificatePages":      "CreateHsmClientCertificatePages",
			"CreateHSMClientCertificateRequest":    "CreateHsmClientCertificateRequest",
	...
	"github.com/tetrafolium/aws-sdk-go/service/route53": &packageRenames{
		operations: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/route53/route53iface": &packageRenames{
		operations: map[string]string{
			"GetCheckerIPRanges":        "GetCheckerIpRanges",
			"GetCheckerIPRangesPages":   "GetCheckerIpRangesPages",
			"GetCheckerIPRangesRequest": "GetCheckerIpRangesRequest",
	...
	"github.com/tetrafolium/aws-sdk-go/service/route53domains": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"DNSSec":           "DnsSec",
	...
	"github.com/tetrafolium/aws-sdk-go/service/route53domains/route53domainsiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/s3": &packageRenames{
		operations: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/s3/s3manager": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"UploadID": "UploadId",
	...
	"github.com/tetrafolium/aws-sdk-go/service/s3/s3iface": &packageRenames{
		operations: map[string]string{
			"DeleteBucketCORS":        "DeleteBucketCors",
			"DeleteBucketCORSPages":   "DeleteBucketCorsPages",
			"DeleteBucketCORSRequest": "DeleteBucketCorsRequest",
	...
	"github.com/tetrafolium/aws-sdk-go/service/ses": &packageRenames{
		operations: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/ses/sesiface": &packageRenames{
		operations: map[string]string{
			"GetIdentityDKIMAttributes":        "GetIdentityDkimAttributes",
			"GetIdentityDKIMAttributesPages":   "GetIdentityDkimAttributesPages",
			"GetIdentityDKIMAttributesRequest": "GetIdentityDkimAttributesRequest",
	...
	"github.com/tetrafolium/aws-sdk-go/service/sns": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"AWSAccountID":           "AWSAccountId",
	...
	"github.com/tetrafolium/aws-sdk-go/service/sns/snsiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/sqs": &packageRenames{
		operations: map[string]string{
	...
	"github.com/tetrafolium/aws-sdk-go/service/sqs/sqsiface": &packageRenames{
		operations: map[string]string{
			"GetQueueURL":        "GetQueueUrl",
			"GetQueueURLPages":   "GetQueueUrlPages",
			"GetQueueURLRequest": "GetQueueUrlRequest",
	...
	"github.com/tetrafolium/aws-sdk-go/service/ssm": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"InstanceID": "InstanceId",
	...
	"github.com/tetrafolium/aws-sdk-go/service/ssm/ssmiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/storagegateway": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"DiskID":             "DiskId",
	...
	"github.com/tetrafolium/aws-sdk-go/service/storagegateway/storagegatewayiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/sts": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"ARN":             "Arn",
	...
	"github.com/tetrafolium/aws-sdk-go/service/sts/stsiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/support": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"AttachmentID":     "AttachmentId",
	...
	"github.com/tetrafolium/aws-sdk-go/service/support/supportiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/swf": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"ActivityID":                   "ActivityId",
	...
	"github.com/tetrafolium/aws-sdk-go/service/swf/swfiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/tetrafolium/aws-sdk-go/service/workspaces": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"BundleID":                 "BundleId",
	...
	"github.com/tetrafolium/aws-sdk-go/service/workspaces/workspacesiface": &packageRenames{
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
